...
import image3 from "../images/EImages/Adoration.webp"
import { Container, Row, Col, Card} from 'react-bootstrap';
function ER(){
    return(
        <div className="pt-5 bg-image" >
        <Container className='justify-content-md-center pt-3 border border-primary rounded-5 shadow-lg p-3 mb-5 bg-body rounded container-fluid' style={{backgroundImage:`url('https://veym.net/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftnttlogo-1.bf52e71a.png&w=3840&q=75'1)`}}>
            ...
            <Row className='justify-content-md-center pt-3 '>
                <Col align="center">
                    <Card className= 'border rounded-5 shadow-lg p-3 mb-5 bg-body rounded' style={{ width: '18rem' }} align="center">
                        <Card.Header className='fs-5 fw-bold'> Body and Blood Of Christ</Card.Header>
